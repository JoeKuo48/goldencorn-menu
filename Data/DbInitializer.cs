        ...
        public static void Initialize(AppDbContext context)
        {
            ...
            context.SaveChanges();
                ...
                var defaultSettings = new Dictionary<string, (string Value, string Desc)>
                {
                    ...
                    ["BoxABadge"] = ("[ 靈魂美式餐點 · 預約外帶 ]", "A框頂部徽章"),
                    ["BoxAIcon"] = ("/img/box_b_icon.jpg", "A框圖示/圖片"),
                    ["BoxATitle"] = ("A. 門市菜單", "A框中文品名"),
                    ["BoxASubtitle"] = ("DINER MENU & ORDERING", "A框英文品名"),
                    ["BoxADesc"] = ("個人獨享或雙人經典美式餐盤！自由搭配主餐肉類、美式配菜與自選澱粉。", "A框說明"),
                    ["BoxABullets"] = ("德州燻烤牛胸肉/克里奧雞\n美式奶油玉米/蘋果捲心菜\n*線上預約取餐時間、Line Pay快速結帳", "A框特色條列"),
                    ["BoxABtnText"] = ("進入線上點餐", "A框按鈕文字"),
                    ["BoxALink"] = ("/menu.html", "A框連結"),

                    ["BoxBBadge"] = ("[ 團體聚會 · 露營野餐 · 預約外燴 ]", "B框頂部徽章"),
                    ["BoxBIcon"] = ("/img/box_a_icon.jpg", "B框圖示/圖片"),
                    ["BoxBTitle"] = ("B. 派對餐盒", "B框中文品名"),
                    ["BoxBSubtitle"] = ("PARTY BOX & CATERING", "B框英文品名"),
                    ["BoxBDesc"] = ("專為露營野餐、朋友聚會、公司下午茶與派對打造的大份量美式分享盛宴！", "B框說明"),
                    ["BoxBBullets"] = ("燻烤肉拼盤/美式炸物\n黃金玉米肋條/嫩葉沙拉\n玉米布丁麵包/布朗尼\n手工獨門醬料\n*一對一客製化諮詢100%享受", "B框特色條列"),
                    ["BoxBBtnText"] = ("探索派對餐盒", "B框按鈕文字"),
                    ["BoxBLink"] = ("/party.html", "B框連結"),
