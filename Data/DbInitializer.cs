...
namespace GoldenCornOrder.Data
{
    public static class DbInitializer
    {
        public static void Initialize(AppDbContext context)
        {
            ...
            // Helper to insert or update MenuItem (guarantees latest defaults)
            void EnsureMenuItem(int catId, string name, string engName, decimal price, string desc, string? badge, bool reqPlate, int order, bool isAvailable = true, string img = "/img/2.jpg")
            {
            ...
            EnsureMenuItem(catPlates.Id, "克里奧雞腿排", "Creole Chicken Thigh", 180, "南方香料醃製, 烤出焦香外皮與飽滿肉汁。", "人氣", true, 1, true, "/img/2.jpg");
            EnsureMenuItem(catPlates.Id, "古巴風烤豬排", "Cuban Grilled Pork Chop", 190, "軟嫩豬排，塗上由橙汁、檸檬、歐芹、蒜頭及橄欖油做成的Mojo青醬，清新略帶微酸。", null, true, 2, false, "/img/2.jpg");
            EnsureMenuItem(catPlates.Id, "德州燻烤豬梅花", "Texas Smoked Pork Collar", 190, "獨門香料慢烤16小時,香氣逼人軟嫩不油膩。", "招牌", true, 3, true, "/img/2.jpg");
            EnsureMenuItem(catPlates.Id, "卡津風味烤魚", "Cajun Grilled Fish", 230, "卡津為路易斯安那州的經典風味，多種香草香料混合，略帶煙燻味及溫和草本香氣。", null, true, 4, false, "/img/2.jpg");
            EnsureMenuItem(catPlates.Id, "德州燻烤牛胸肉", "Texas Smoked Brisket", 250, "冠軍香料柴火48小時熟成，不一定每天都有。", "主廚推薦", true, 5, true, "/img/2.jpg");
            EnsureMenuItem(catPlates.Id, "萊姆炭香鮭魚菲力", "Grilled Lime Salmon Fillet", 240, "蚵仔寮直送整條鮭魚只取菲力，厚切鮭魚丁口感飽滿, 外層帶有淡淡煙燻香氣。", null, true, 6, true, "/img/2.jpg");
            EnsureMenuItem(catPlates.Id, "克里奧鮮蝦", "Creole Shrimp", 210, "南方香料醃製, 淡淡地萊姆清香，大火炙燒脆彈鮮甜。", null, true, 7, false, "/img/2.jpg");

            // 2. 美墨小點（SNACKS）
            EnsureMenuItem(catSnacks.Id, "海鹽經典美式細薯", "Classic American Fries with Sea Salt", 70, "鞋帶細薯，通常在餐酒館才吃得到。", null, false, 1, true, "/img/4.jpg");
            EnsureMenuItem(catSnacks.Id, "美式燒烤玉米肋排", "Corn Ribs", 120, "Golden Corn招牌！沾特調酸奶醬實在太搭。", "必點招牌", false, 2, true, "/img/4.jpg");
            EnsureMenuItem(catSnacks.Id, "辣辣的花椒細薯", "Fries with Confit Garlic and Chili", 90, "辣辣的。", "微辣推薦", false, 3, true, "/img/4.jpg");
            EnsureMenuItem(catSnacks.Id, "燻烤起司馬鈴薯", "Smoked Potato with Cheese", 60, "刷上奶油燻烤至綿密, 塞入傑克寇比起司。", null, false, 4, true, "/img/4.jpg");
            EnsureMenuItem(catSnacks.Id, "黑松露醬細薯", "Fries with Black Truffle Sauce", 120, "黑松露醬好貴，主廚不惜成本。", null, false, 5, false, "/img/4.jpg");
            EnsureMenuItem(catSnacks.Id, "美式酸奶炸雞柳條", "Chicken Tender with Yogurt", 150, "住太遠不要點，炸物不夠脆主廚會傷心。", "人氣", false, 6, false, "/img/4.jpg");
            EnsureMenuItem(catSnacks.Id, "楓糖辣水牛城美式炸雞柳條", "Chicken Tender with Maple Buffalo Sauce", 180, "吃過最狂的水牛城秘方(謝謝老闆艾迪) 住太遠不要點，炸物現吃才讚。", "美式經典", false, 7, false, "/img/4.jpg");

            // 3. 吃點蔬菜 & 最佳綠葉 & 醬料
            EnsureMenuItem(catVeggies.Id, "燒烤厚切櫛瓜", "Grilled Thick Cut Zucchini", 100, "厚切才爽。", null, false, 1, true, "/img/5.jpg");
            EnsureMenuItem(catVeggies.Id, "燒烤杏鮑菇", "Grilled King Oyster Mushroom", 100, "烤杏鮑菇需要耐心。", null, false, 2, true, "/img/5.jpg");
            EnsureMenuItem(catVeggies.Id, "燒烤甜椒青椒", "Grilled Green and Bell Pepper", 100, "甜椒好貴，但配色才美。", null, false, 3, true, "/img/5.jpg");

            EnsureMenuItem(catSalad.Id, "純 水耕嫩生菜杯", "Mesclun", 60, "內行人點來包肉吃。喜歡可以專門配送。", null, false, 1, true, "/img/6.jpg");
            EnsureMenuItem(catSalad.Id, "燒烤嫩雞胸沙拉", "Grilled Chicken Breast Salad", 150, "經典不敗，凱撒的升級低脂版！", "輕食推薦", false, 2, false, "/img/6.jpg");

            EnsureMenuItem(catSauces.Id, "卡羅萊納BBQ燒烤醬", "Carolina BBQ Sauce", 15, "經典道地濃郁酸甜，胡椒的微微辣是大人的口味。", null, false, 1, true, "/img/6.jpg");
            EnsureMenuItem(catSauces.Id, "蒔蘿優格醬", "Ranch Sauce", 15, "蒔蘿與優格特調，簡單清爽什麼都能沾。", null, false, 2, true, "/img/6.jpg");
            ...
            var defaultSettings = new Dictionary<string, (string Value, string Desc)>
            {
                ...
                ["Announcement"] = ("🔥 歡迎光臨 Golden Corn！", "前台跑馬燈公告"),
                ["StoreTip"] = ("", "門市資訊燈泡備註/溫馨提示"),
                ["BankCode"] = ("822", "銀行代碼"),
                ["BankName"] = ("中國信託", "銀行名稱"),
                ...
                ["CoverSwipeBtnText"] = ("SWIPE FOR MY STORY... ↓", "滑動按鈕文字"),
                ["PortalPillTag"] = ("CHOOSE YOUR ORDER TYPE", "模式膠囊標籤"),
                ["PortalTitle"] = ("選擇您的美味模式", "模式大標題"),
                ["PortalSubtitle"] = ("外公的田間貨櫃工作室 · 柴火低溫慢燻 · 慢靈魂料理", "模式副標題"),
                ["PortalNoticeBtnText"] = ("[ 門市公告與營業資訊 ]", "門市公告按鈕文字"),
                ["PortalHistoryBtnText"] = ("[ 查詢我的訂單 ]", "查詢訂單按鈕文字"),

                // Box A: 門市預約點餐 (menu.html)
                ["BoxATag"] = ("🌟 經典門市點餐", "方塊A標籤"),
                ["BoxATitle"] = ("門市線上點餐", "方塊A標題"),
                ["BoxASubtitle"] = ("Daily Fresh Menu & Ordering", "方塊A英文標題"),
                ["BoxADesc"] = ("煙燻牛胸肉、極嫩豬梅花與招牌玉米肋排，現點現做。", "方塊A說明"),
                ["BoxABadge"] = ("[ 靈魂美式餐點 · 預約外帶 ]", "方塊A角標"),
                ["BoxAIcon"] = ("/img/box_b_icon.jpg", "方塊A圖示"),
                ["BoxABullets"] = ("德州燻烤牛胸肉\n德州燻烤豬梅花\n美式奶油玉米\n蘋果捲心菜\n*線上預約取餐時間、Line Pay快速結帳", "方塊A重點列"),
                ...
                ["PartyHeroBadge"] = ("PARTY BOX & CATERING", "派對主視覺角標"),
                ["PartyHeroTitle"] = ("美式煙燻派對餐盒", "派對主視覺標題"),
                ["PartyHeroSubtitle"] = ("露營野餐 · 朋友歡聚 · 企業團訂 · 生日派對的大份量美式靈魂盛宴！", "派對主視覺副標"),
                ["PartyHeroTags"] = ("原木柴燒慢燻 | 美式靈魂炸物 | 招牌黃金玉米", "派對特色標籤"),
                ...
                ["PartySet1Label"] = ("組合 1", "組合1標籤"),
                ["PartySet1Portion"] = ("適合 3-4 人享用", "組合1副標籤/份量說明"),
                ["PartySet1Title"] = ("美式慢火煙燻四人分享派對", "組合1品名"),
                ...
                ["PartySet2Label"] = ("組合 2", "組合2標籤"),
                ["PartySet2Portion"] = ("適合 6-8 人澎湃聚會", "組合2副標籤/份量說明"),
                ["PartySet2Title"] = ("主廚豪華雙牛海陸派對", "組合2品名"),
